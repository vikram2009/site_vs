    ...
    659: function (e, t, r) {
      ...
      function l(e) {
        n && n(e);
        {
          var t;
          let r = {
              dsn: "65n3sDKxAgzVTckzBF6QudM3vHM",
              id: e.id,
    ...
    1003: function (e, t, r) {
      ...
      class J {
        ...
        change(e, t, r, o, i) {
          ...
          return n(function* () {
            let n, f;
            if (!D(t)) return Y({ url: t, router: l }), !1;
            let h = o._h,
              p =
                h ||
            ...
            l._inFlightRoute &&
              l.clc &&
              (R || J.events.emit("routeChangeError", L(), l._inFlightRoute, H),
              l.clc(),
              (l.clc = null)),
              (r = C.addBasePath(
                w.addLocale(
            ...
            l._inFlightRoute = r;
            let W = A !== v.locale;
            if (!h && l.onlyAHashChange(q) && !W) {
              (v.asPath = q),
                J.events.emit("hashChangeStart", r, H),
              ...
              try {
                ...
                throw (
                  (d.default(z) &&
                    z.cancelled &&
                    J.events.emit("routeChangeError", z, q, H),
                  z)
                );
              }
            ...
            try {
              ...
              return Y({ url: r, router: l }), !1;
            }
            l.urlIsNew(q) || W || (e = "replaceState");
            let K = r;
            ...
            h || J.events.emit("routeChangeStart", r, H);
            try {
              var ec, ed, ef, eh;
              ...
              if ("route" in ep && er) {
                (Q = V = ep.route || Q),
                  H.shallow || (X = Object.assign({}, ep.query || {}, X));
              ...
              if ("type" in ep) {
                ...
                return (
                  Y({ url: ep.destination, router: l }), new Promise(() => {})
                );
              }
              ...
              if ((eS || ew) && eb) {
                if (eb.pageProps && eb.pageProps.__N_REDIRECT) {
                  ...
                  return Y({ url: eC, router: l }), new Promise(() => {});
                }
                if (((v.isPreview = !!eb.__N_PREVIEW), eb.notFound === Z)) {
                  let eM;
                  try {
              ...
              J.events.emit("beforeHistoryChange", r, H),
              ...
              let eL =
                ...
                ek =
                  o._h && !eN && !O && !W && M.compareRouterStates(eI, l.state);
              if (!ek) {
                if (
                  ...
                  throw (h || J.events.emit("routeChangeError", eP, q, H), eP);
                h || J.events.emit("routeChangeComplete", r, H),
        ...
        constructor(
          ...
          (this.sdc = {}),
            ...
            (this.onPopState = (e) => {
              ...
              this._key = u;
              let { pathname: h } = y.parseRelativeUrl(i);
              (!this.isSsr ||
                l !== C.addBasePath(this.asPath) ||
                h !== C.addBasePath(this.pathname)) &&
